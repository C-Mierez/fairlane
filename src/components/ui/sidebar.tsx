...
function Sidebar({
    ...
    if (collapsible === "none") {
        return (
            <div
                data-slot="sidebar"
                className={cn(
                    "bg-sidebar text-sidebar-foreground isolate flex h-full w-(--sidebar-width) flex-col",
                    className,
                )}
                {...props}
            >
        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    className="bg-sidebar text-sidebar-foreground shadow-neo rounded-r-base isolate w-(--sidebar-width) overflow-hidden rounded-l-none p-0 [&>button]:hidden"
                    style={
                        {
    ...
    return (
        <div
            className="group peer text-sidebar-foreground isolate hidden md:block"
            data-state={state}
